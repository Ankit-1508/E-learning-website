...
<head>
  ...
  <?php
    include 'link.php';//data base conneting files present
...
<a class="navbar-brand" href="home_page.php"><img src="Images/logo.png" alt="Logo" style="width: 130px;"></a>
  ...
  <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="https://docs.google.com/spreadsheets/d/1KoxK3lk-4jG2YRRONyT9n6w4pbasJUS9/edit?usp=share_link&ouid=117618982550483437541&rtpof=true&sd=true">Practice Problems</a>
      </li>
  </div>
      ...
      <?php if( isset($_SESSION['username']) && !empty($_SESSION['username']) )//if the value 
      {
      ?>
  ...
  <div class="col-sm-4">
    ...
    <img class="card-img-top" src="Images/team.jpg" alt="the image alt text here" style="height: 250px;">
      ...
      <div class="card-body text-center">
        ...
        <h5 class="card-title"> Ashish Yadav </h5>
 
        <p class="card-text"> About Ashish </p>
  ...
  <div class="col-sm-4">
    ...
    <img class="card-img-top" src="Images/team.jpg" alt="the image alt text here" style="height: 250px;">
      ...
      <div class="card-body text-center">
        ...
        <h5 class="card-title"> Kishan Singh </h5>
 
        <p class="card-text"> About Kishan </p>
  ...
  <div class="col-sm-4">
    ...
    <img class="card-img-top" src="Images/team.jpg" alt="the image alt text here" style="height: 250px;">
      ...
      <div class="card-body text-center">
        ...
        <h5 class="card-title text-center"> Ankit Kumar Singh </h5>
 
        <p class="card-text"> About Ankit </p>
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>
          <i class="fas fa-home mr-3"></i> Prayagraj,Uttarpradesh </p>
        <p>
          <i class="fas fa-envelope mr-3"></i> sinxander24@gmail.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> +91-9956940952</p>
        <p>
          <i class="fas fa-phone mr-3"></i> +91-9935538462</p>
      </div>
      <!-- Grid column -->
      ...
      <div class="col-md-5 col-lg-4 ml-lg-0">
        ...
        <div class="text-center text-md-right">
          <ul class="list-unstyled list-inline">
            ...
            <li class="list-inline-item">
              <a class="btn-floating btn-sm rgba-white-slight mx-1" href=""> <!--twitter link-->
